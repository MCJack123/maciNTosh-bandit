...
typedef unsigned short blk_short_t;
#define	BLK_STS_OK 0
...
#define BLK_STS_DM_REQUEUE    ((blk_status_t)11)
 ...
 */
#define BLK_STS_ZONE_OPEN_RESOURCE	((blk_status_t)14)
 ...
 */
#define BLK_STS_ZONE_ACTIVE_RESOURCE	((blk_status_t)15)
 ...
 */
#define BLK_STS_OFFLINE		((blk_status_t)16)

/*
 * BLK_STS_DURATION_LIMIT is returned from the driver when the target device
 * aborted the command because it exceeded one of its Command Duration Limits.
 */
#define BLK_STS_DURATION_LIMIT	((blk_status_t)17)

/*
 * Invalid size or alignment.
 */
#define BLK_STS_INVAL	((blk_status_t)19)
...
#define BLK_OPEN_STRICT_SCAN	((blk_mode_t)(1 << 6))
...
typedef unsigned int 	q_req_flags_t;
...
#define REQ_FAILFAST_DEV	\
			(blk_opf_t)(1ULL << __REQ_FAILFAST_DEV)
#define REQ_FAILFAST_TRANSPORT	\
			(blk_opf_t)(1ULL << __REQ_FAILFAST_TRANSPORT)
#define REQ_FAILFAST_DRIVER	\
			(blk_opf_t)(1ULL << __REQ_FAILFAST_DRIVER)
#define REQ_SYNC	(blk_opf_t)(1ULL << __REQ_SYNC)
#define REQ_META	(blk_opf_t)(1ULL << __REQ_META)
#define REQ_PRIO	(blk_opf_t)(1ULL << __REQ_PRIO)
#define REQ_NOMERGE	(blk_opf_t)(1ULL << __REQ_NOMERGE)
#define REQ_IDLE	(blk_opf_t)(1ULL << __REQ_IDLE)
#define REQ_INTEGRITY	(blk_opf_t)(1ULL << __REQ_INTEGRITY)
#define REQ_FUA		(blk_opf_t)(1ULL << __REQ_FUA)
#define REQ_PREFLUSH	(blk_opf_t)(1ULL << __REQ_PREFLUSH)
#define REQ_RAHEAD	(blk_opf_t)(1ULL << __REQ_RAHEAD)
#define REQ_BACKGROUND	(blk_opf_t)(1ULL << __REQ_BACKGROUND)
#define REQ_NOWAIT	(blk_opf_t)(1ULL << __REQ_NOWAIT)
#define REQ_POLLED	(blk_opf_t)(1ULL << __REQ_POLLED)
#define REQ_ALLOC_CACHE	(blk_opf_t)(1ULL << __REQ_ALLOC_CACHE)
#define REQ_SWAP	(blk_opf_t)(1ULL << __REQ_SWAP)
#define REQ_DRV		(blk_opf_t)(1ULL << __REQ_DRV)
#define REQ_FS_PRIVATE	(blk_opf_t)(1ULL << __REQ_FS_PRIVATE)
#define REQ_ATOMIC	(blk_opf_t)(1ULL << __REQ_ATOMIC)

#define REQ_NOUNMAP	(blk_opf_t)(1ULL << __REQ_NOUNMAP)
