...
#define BLK_FEAT_WRITE_CACHE		((blk_features_t)(1u << 0))

/* supports passing on the FUA bit */
#define BLK_FEAT_FUA			((blk_features_t)(1u << 1))

/* rotational device (hard drive or floppy) */
#define BLK_FEAT_ROTATIONAL		((blk_features_t)(1u << 2))

/* contributes to the random number pool */
#define BLK_FEAT_ADD_RANDOM		((blk_features_t)(1u << 3))

/* do disk/partitions IO accounting */
#define BLK_FEAT_IO_STAT		((blk_features_t)(1u << 4))

/* don't modify data until writeback is done */
#define BLK_FEAT_STABLE_WRITES		((blk_features_t)(1u << 5))

/* always completes in submit context */
#define BLK_FEAT_SYNCHRONOUS		((blk_features_t)(1u << 6))

/* supports REQ_NOWAIT */
#define BLK_FEAT_NOWAIT			((blk_features_t)(1u << 7))

/* supports DAX */
#define BLK_FEAT_DAX			((blk_features_t)(1u << 8))

/* supports I/O polling */
#define BLK_FEAT_POLL			((blk_features_t)(1u << 9))

/* is a zoned device */
#define BLK_FEAT_ZONED			((blk_features_t)(1u << 10))

/* supports PCI(e) p2p requests */
#define BLK_FEAT_PCI_P2PDMA		((blk_features_t)(1u << 12))

/* skip this queue in blk_mq_(un)quiesce_tagset */
#define BLK_FEAT_SKIP_TAGSET_QUIESCE	((blk_features_t)(1u << 13))

/* bounce all highmem pages */
#define BLK_FEAT_BOUNCE_HIGH		((blk_features_t)(1u << 14))

/* undocumented magic for bcache */
#define BLK_FEAT_RAID_PARTIAL_STRIPES_EXPENSIVE \
	((blk_features_t)(1u << 15))
...
#define BLK_FLAG_WRITE_CACHE_DISABLED	((blk_flags_t)(1u << 0))

/* I/O topology is misaligned */
#define BLK_FLAG_MISALIGNED		((blk_flags_t)(1u << 1))
