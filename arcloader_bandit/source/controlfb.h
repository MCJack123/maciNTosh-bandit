...
extern void find_vram_size(struct fb_info_control *p);
extern int controlfb_set_par (struct fb_info_control *info);
extern int controlfb_blank(int blank_mode, struct fb_info_control *info);
